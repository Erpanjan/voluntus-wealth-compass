...
const translations = {
  en: {
    ...
    'waitlist.firstNameShort': 'First name',
    'waitlist.lastName': 'Last name',
    'waitlist.lastNameShort': 'Last name',
    ...
    'waitlist.preferredContactShort': 'Email, Phone, WeChat, etc.',
    'waitlist.contactInfo': 'Your contact information',
    'waitlist.contactInfoShort': 'Your contact details',
    'waitlist.interests': 'Any specific interests or questions? (optional)',
    'waitlist.interestsShort': 'Questions or interests (optional)',

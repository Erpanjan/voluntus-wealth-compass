...
interface RiskPreferencesQuestionProps {
  goals: GoalType[];
  value: string[];
  onChange: (value: string[]) => void;
}

const RiskPreferencesQuestion: React.FC<RiskPreferencesQuestionProps> = ({ goals, value = [], onChange }) => {
  ...
  console.log("RiskPreferencesQuestion - Goals received:", goals);
  console.log("RiskPreferencesQuestion - Filtered goals:", filteredGoals);
  ...
  return (
    <QuestionCard 
      question="Rank your goals by the level of risk you're willing to take for each"
      description="Drag or use the arrows to reorder your goals based on risk willingness. The goal with highest risk tolerance should be at the top."
    >
...
export default RiskPreferencesQuestion;

...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-brand-accent text-white hover:bg-brand-accent/90 shadow-sm hover:shadow-md",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-brand-secondary bg-background hover:bg-brand-secondary hover:text-brand-accent",
        secondary:
          "bg-brand-secondary text-brand-accent hover:bg-brand-secondary/80",
        ghost: "hover:bg-brand-secondary hover:text-brand-accent",

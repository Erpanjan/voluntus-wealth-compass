  ...
  const carouselSections = [
    {
      ...
      content: (
        <Section id="gambling" background="light" carouselItem={true}>
          <div className="grid md:grid-cols-1 gap-8 items-center max-w-3xl mx-auto w-full h-full">
            <div className="space-y-6 animate-fade-in-up">
              ...
              <div className="space-y-4 text-[#9F9EA1] text-lg font-light">
                <p>
              ...
              <Button 
                asChild 
                size="lg"
                className="bg-black/80 hover:bg-black text-white transition-all duration-300 mt-4"
              >

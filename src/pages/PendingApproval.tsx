    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-3xl font-inter font-semibold mb-6">Thank You for Your Application</h1>
          <p className="text-sm md:text-base font-inter text-gray-600 mb-8">
          ...
          <Card className="max-w-lg mx-auto mb-10">
            <CardContent className="p-8">
              ...
              <h2 className="text-xl font-inter font-medium mb-4">Application Submitted Successfully</h2>
              <p className="text-gray-600 font-inter font-light text-sm mb-6">
          ...
          <p className="mt-8 text-xs text-gray-500 font-inter">
